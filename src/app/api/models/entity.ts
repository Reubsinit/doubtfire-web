 ...
 * entity can be transfered to/from the server, and there are functions to assist with
 ...
 * 2: Overide @method updateFromJson to update the entity with data from a json object.
